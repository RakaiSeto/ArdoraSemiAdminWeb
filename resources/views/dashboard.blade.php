            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Exchange ETH/BTC</h4>
                        ...
                        <div class="box-body">
                            <div class="chart">
                                <div id="chartdiv1" class="h-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="chart">
                                        <div id="chartdiv3" class="h-190" style="height:192px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <a class="box box-link-pop text-center" href="javascript:void(0)">
                                <div class="box-body">
                                    <p class="font-size-36 text-danger">
                        ...
                        <div class="media bb-1 border-fade">
                            ...
                            <div class="media-body">
                                <p>
                                    ...
                                    <time class="float-right" datetime="2017">24 min ago</time>
                                </p>
                ...
                <div class="col-xl-4 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="chart">
                                <div id="e_chart_5" class="h-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="chart">
                                <div id="e_chart_2" class="h-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-5 col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="chart">
                                <div id="e_chart_3" class="h-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
