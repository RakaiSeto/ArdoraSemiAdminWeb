                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control select2 w-p100" id="findField">
                                                ...
                                                <option value="menu">Activity</option>
                                                <option value="remote_ip_address">Remote IP</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="box">
                            <div class="box-header no-border">
                                ...
                                <div class="mailbox-controls px-0 pt-20 pb-0">
                                    <button type="button" class="btn btn-info btn-sm" id="btnFind" data-toggle="modal" data-target="#modalFindWebUser">Find Activity</button>                                
                                </div>
                            </div>
                            ...
                            <div class="box-body pt-0">
                                <div class="mailbox-messages bg-white">
                                    <div class="table-responsive">
                                        <table id="tableActivity" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                            <thead>
                                            <tr>
    ...
    <script>
        $(document).ready( function() {
            let tableActivity = $('#tableActivity').DataTable({
                    ...
                    ajax: "/tblActivity",
                    columns: [
                        { data: 'date_time', name: 'Date Time', searchable: true},
                        { data: 'username', name: 'Email (username)'},
                        { data: 'menu', name: 'Menu'},
                        { data: 'activity', name: 'Activity'},
                        { data: 'remote_ip_address', name: 'Remote IP'},
            ...
            $('#btnFind').on('click', function() {
                tableActivity.ajax.url("/tblActivity?&searchcategory=" + $('#findField').val() + "&searchkeyword=" + $('#findKeyword').val()).load()
            })
